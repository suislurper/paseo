    ...
    git: {
      actions: {
        ...
        archiveWarning: {
          ...
          mergedIntoDefault: "Merged into {{resolvedRef}}",
          equivalentToMerged: "Changes equivalent to merged work",
          fetchedRefsNote:
            "Based on fetched Git refs. Cleanup verifies remote preservation again before removing files.",
